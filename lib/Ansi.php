...
class Ansi {
    ...
    public static function htmltoansi($color) {
        ...
        } elseif(preg_match('/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/', $color, $m)) {
        ...
        elseif($hsv['h'] < 0.25) $r = $r . 'brown';
        elseif($hsv['h'] < 0.41) $r = $r . 'green';
        elseif($hsv['h'] < 0.58) $r = $r . 'cyan';
        elseif($hsv['h'] < 0.75) $r = $r . 'blue';
        elseif($hsv['h'] < 0.83) $r = $r . 'purple';
        else $r = $r . 'red';
