...
class MysqlConnection extends Connection
{
    ...
    protected function reset()
    {
        ...
        if ($status === false) {
            throw new Exception("Error resetting the connection. " . implode(';', $this->_pdo->errorInfo()));
        }
        return true;
    }
    ...
    public function dropRoutine($routineName, $routineType = 'FUNCTION', $schema = false)
    {
        ...
        if (!in_array($routineType, ['FUNCTION', 'PROCEDURE'])) {
            throw new Exception("Invalid routine type '$routineType'");
        }
