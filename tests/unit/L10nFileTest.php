...
class L10nFileTest extends Unit
{
	...
	public function testL()
    {
	    ...
	    $this->assertEquals(dirname(__DIR__).DIRECTORY_SEPARATOR.'_data/testapp/messages/cat1', App::$app->l10n->directory('cat1'));
	    $this->assertEquals(dirname(__DIR__).DIRECTORY_SEPARATOR.'_data/testapp/messages/app', App::$app->l10n->directory('app'));
	    ...
	    $this->assertEquals(dirname(__DIR__).DIRECTORY_SEPARATOR.'_data/testapp/messages', App::$app->l10n->dir);
